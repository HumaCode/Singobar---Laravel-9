...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('frontend') }}/assets//css/templatemo-onix-digital.css">
                    ...
                    <nav class="main-nav">
                        ...
                        <ul class="nav">
                            ...
                            <li class="scroll-to-section">
                                <div class="main-red-button-hover"><a href="{{ route('login') }}">Login
                                        Sekarang</a></div>
                            </li>
                        </ul>
                ...
                <div class="col-lg-12">
                    <div class="owl-carousel owl-services">
                        <div class="item">
                            ...
                            <div class="icon"><img src="{{ asset('frontend') }}/assets//images/service-icon-01.png"
                                    alt=""></div>
                            <p>Feel free to use this template for your business</p>
                        </div>
                        <div class="item">
                            <h4>Develop The Best Strategy for Business</h4>
                            <div class="icon"><img src="{{ asset('frontend') }}/assets//images/service-icon-02.png"
                                    alt=""></div>
                            <p>Get to know more about the topic in details</p>
                        </div>
                        <div class="item">
                            <h4>UI / UX Design and Development</h4>
                            <div class="icon"><img src="{{ asset('frontend') }}/assets//images/service-icon-03.png"
                                    alt=""></div>
                            <p>Get to know more about the topic in details</p>
                        </div>
                        <div class="item">
                            <h4>Discover &amp; Explore our SEO Tips</h4>
                            <div class="icon"><img src="{{ asset('frontend') }}/assets//images/service-icon-04.png"
                                    alt=""></div>
                            <p>Feel free to use this template for your business</p>
                        </div>
                        <div class="item">
            ...
            <div class="row">
                <div class="col-lg-6 align-self-center">
                    <div class="left-image">
                        <img src="{{ asset('frontend') }}/assets//images/about-left-image.png"
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="fact-item">
                                    <div class="count-area-content">
                                        <div class="icon">
                                            <img src="{{ asset('frontend') }}/assets//images/service-icon-01.png"
                                                alt="">
                                        </div>
                            ...
                            <div class="col-lg-4">
                                <div class="fact-item">
                                    <div class="count-area-content">
                                        <div class="icon">
                                            <img src="{{ asset('frontend') }}/assets//images/service-icon-02.png"
                                                alt="">
                                        </div>
                            ...
                            <div class="col-lg-4">
                                <div class="fact-item">
                                    <div class="count-area-content">
                                        <div class="icon">
                                            <img src="{{ asset('frontend') }}/assets//images/service-icon-03.png"
                                                alt="">
                                        </div>
                            ...
                            <div class="thumb">
                                ...
                                <div class="hover-effect">
                                    <div class="inner-content">
                                        ...
                                        <span>Digital {{ asset('frontend') }}/assets/</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <div class="menu">
                                        <div class="active">
                                            <div class="thumb">
                                                <img src="{{ asset('frontend') }}/assets//images/video-thumb-01.png"
                                                    alt="">
                                                <div class="inner-content">
                                                    <h4>Project One</h4>
                                                    <span>SEO &amp; Marketing</span>
                                        ...
                                        <div>
                                            <div class="thumb">
                                                <img src="{{ asset('frontend') }}/assets//images/video-thumb-02.png"
                                                    alt="">
                                                <div class="inner-content">
                                                    <h4>Second Project</h4>
                                                    <span>Advertising &amp; Marketing</span>
                                        ...
                                        <div>
                                            <div class="thumb">
                                                <img src="{{ asset('frontend') }}/assets//images/video-thumb-03.png"
                                                    alt="Marketing">
                                                <div class="inner-content">
                                                    <h4>Project Three</h4>
                                                    <span>Digital &amp; Marketing</span>
                                        ...
                                        <div>
                                            <div class="thumb">
                                                <img src="{{ asset('frontend') }}/assets//images/video-thumb-04.png"
                                                    alt="SEO Work">
                                                <div class="inner-content">
                                                    <h4>Fourth Project</h4>
                                                    <span>SEO &amp; Advertising</span>
