                        ...
                        <div class="dropdown-menu dropdown-menu-right notification">
                            ...
                            <ul class="noti-body">
                                ...
                                <li class="notification">
                                    <div class="media">
                                        <img class="img-radius"
                                            src="{{ asset('backend') }}/assets/images/user/avatar-1.jpg"
                                ...
                                <li class="notification">
                                    <div class="media">
                                        <img class="img-radius"
                                            src="{{ asset('backend') }}/assets/images/user/avatar-2.jpg"
                                            alt="Generic placeholder image">
                                        <div class="media-body">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                ...
                                                <div class="d-inline-block align-middle">
                                                    <img src="{{ asset('backend') }}/assets/images/user/avatar-4.jpg"
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <div class="d-inline-block align-middle">
                                                    <img src="{{ asset('backend') }}/assets/images/user/avatar-3.jpg"
                                                        alt="user image" class="img-radius wid-40 align-top m-r-15">
                                                    <div class="d-inline-block">
                                                        <h6>William Jem</h6>
